...
Use `hasher -wr [directory]` to compute and write the checksums of all files in a directory to a file

Use `hasher -cr [directory]` to compare the checksums of a .sha256 file located inside the directory to all the files there
